const Main = () => {
    return (
        <>
            <main className="bg-[#b8ff65] rounded-3xl mx-4 mt-5 h-[560px] text-center md:h-[480px] lg:h-[550px] lg:mt-0 xl:h-[620px] xl:mx-20">
                ...
                xl:block xl:top-[-400px]
                2xl:block" src="https://moonli.me/wp-content/themes/moonli/images/hero_background.png" alt="Main image"/>

                <a href="#networks">
                    <button className="w-10 mt-16 bg-black rounded-full cursor-pointer sm:mt-0 md:relative md:top-[-340px] lg:relative lg:top-[-500px] xl:w-16 xl:h-16 xl:top-[-600px] hover:bg-[#353535] transition-all"><img className="p-1 xl:p-3" src="../../iconDown.png" alt="Icono abajo"/></button>
                </a>
            </main>
        </>
    )

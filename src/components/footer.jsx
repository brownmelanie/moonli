    ...
    return (
        <footer className="bg-black flex flex-col items-center">
            ...
            <ul className="py-5 grid grid-cols-2 auto-rows-[70px] mt-12">
                <li><a className="text-white text-[18px] px-5" href="">Networks</a></li>
                <li><a className="text-white text-[18px] px-5" href="">Selection</a></li>
                <li><a className="text-white text-[18px] px-5" href="">Reliability</a></li>
                <li><a className="text-white text-[18px] px-5" href="">Giving Back</a></li>
                <li><a className="text-white text-[18px] px-5" href="">Get in Touch</a></li>
            </ul>
